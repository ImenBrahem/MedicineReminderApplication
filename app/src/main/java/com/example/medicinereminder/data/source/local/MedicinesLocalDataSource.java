package com.example.medicinereminder.data.source.local;

import android.content.Context;

import com.example.medicinereminder.data.source.MedicineAlarm;
import com.example.medicinereminder.data.source.MedicineDataSource;
import com.example.medicinereminder.data.source.History;
import com.example.medicinereminder.data.source.Pills;
...
public class MedicinesLocalDataSource implements MedicineDataSource {
    ...
    @Override
    public void getMedicineListByDay(int day, MedicineDataSource.LoadMedicineCallbacks callbacks) {
